  ...
  return (
    <>
      ...
      <section id="fases" className="card" style={{ marginTop: 16 }}>
        ...
        <p className="muted">
          A proposta organiza-se em seis fases formativas interdependentes, concebidas para criar um ciclo contínuo de aprendizagem:
        </p>
        <ol>
          <li>
            <h3>
              <strong>Motivar:</strong>
            </h3>
          ...
          <li>
            <h3>
              <strong>Apresentar Conceitos:</strong>
            </h3>
          ...
          <li>
            <h3>
              <strong>Planejar e Prototipar:</strong>
            </h3>
          ...
          <li>
            <h3>
              <strong>Experimentar com Tecnologia:</strong>
            </h3>
          ...
          <li>
            <h3>
              <strong>Analisar e Ajustar:</strong>
            </h3>
          ...
          <li>
            <h3>
              <strong>Refletir e Compartilhar:</strong>
            </h3>
      ...
      <section id="protocolo" className="card">
        ...
        <div className="figure">
          <img alt="Protocolo" src="/protocoloMAPEAR.png" />
        </div>
      </section>
      ...
      <section id="diferenciais" className="card" style={{ marginTop: 16 }}>
        ...
        <ul>
          <li>
            <strong>Flexibilidade:</strong> aplicável com ou sem tecnologia digital;
          </li>
          <li>
            <strong>Interdisciplinaridade:</strong> integração do PC com conteúdos curriculares e problemas reais;
          </li>
          <li>
            <strong>Protagonismo:</strong> incentiva autoria e autonomia de alunos e professores;
          </li>
          <li>
            <strong>Ciclos ativos</strong> de teoria, prática e reflexão;
          </li>
          <li>
            <strong>Formação contínua</strong> com trilhas gamificadas e microcertificações;
          </li>
          <li>
            <strong>Colaboração:</strong> socialização de práticas e fortalecimento de redes escolares.
          </li>
        </ul>
      </section>
      ...
      <section id="resultados" className="card" style={{ marginTop: 16 }}>
        ...
        <ol>
          <li>
            <strong>Aprendizagem dos Estudantes:</strong> Engajamento, pensamento crítico, criatividade e competências em PC.
          </li>
          <li>
            <strong>Competências Docentes:</strong> Habilidade de integrar PC e RE em práticas pedagógicas alinhadas à BNCC.
          </li>
          <li>
            <strong>Repertório Pedagógico:</strong> Diversificação de estratégias de ensino com metodologias ativas, gamificação e recursos tecnológicos.
          </li>
          <li>
            <strong>Comunidade de Prática:</strong> Criação de redes colaborativas de alunos e professores que compartilham experiências e aprimoram continuamente a metodologia.
          </li>
        </ol>
      </section>
